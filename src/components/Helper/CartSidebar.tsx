        ...
        <div className="mt-6 mb-6 h-full">
            ...
            {items.length > 0 && (
                <div>
                            ...
                            className="pb-4 border-b-2 border-gray-300 border-opacity-60">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        <Button onClick ={()=>{removeCartHandler(item.id)}} size={"sm"}  className="bg-green-700 text-white hover:text-green-700">Remove</Button>
                                        <Button onClick ={()=>{addCartHandler(item)}}size={"sm"}  className="text-green-700 ">Add</Button>
                                    </div>
                            </div>
                            </div>
                        )
                    ...
                    <Link href="/cart">
                    <SheetClose>
                    <Button className="mt-6 mb-6 w-full bg-green-700 text-white hover:text-green-700" >View All Cart</Button>
                    </SheetClose>
                    </Link>
                </div>
            )}
